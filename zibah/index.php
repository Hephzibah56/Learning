...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Student Login Only </h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                     <label>Enter Student ID: </label>
                        <input type="text" name="regno" class="form-control" value = "<?php echo $res->text?>" />
                ...
                <div class="col-md-6">
                    <div class="alert alert-info">
                        AN INTELLIGENT LEARNING SYSTEM FOR DEAF STUDENTS IN A GHANAIAN UNIVERSITY CLASSROOM
                        <br />
                         <strong> Some of its features include:</strong>
                        <ul>
                            <li>
                            ...
                            <li>
                                Video Transcribing for Deaf student
                            </li>
                            <li>
                                Resources (lecturer slides, transcribed notes)
                            </li>
                        </ul>
