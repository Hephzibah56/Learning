...
// the pincode is correct, display enroll.php file
header("location:enroll.php");
}
else
{
$_SESSION['msg']="Error :Wrong Course code. Please Enter a Valid Course code !!";
}
}
?>
...
<head>
    ...
    <title>Course Code Verification</title>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Student Course Code Verification</h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="red" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
  ...
  <div class="panel-body">
   ...
   <div class="form-group">
    <label for="pincode">Enter Course Code</label>
    <input type="password" class="form-control" id="pincode" name="pincode" placeholder="Coursecode" required />
  </div>
