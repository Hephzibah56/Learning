 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Enroll History  </h2>
                        <a href="transcribe.php"><button class="page-head-line">View Recordings  </button></a>

                        <a href="lecture_slide.php"><button class="page-head-line">View Course Documents </button></a>

                        <a href='inperson.php'><button class="page-head-line">Attend A Class </button></a>
